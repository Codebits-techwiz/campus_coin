...
export const initialTransactions = [
  { id: 't1', type: 'income', categoryId: 'c1', category: 'Allowance', amount: 800, description: 'Monthly family allowance', date: '2026-09-01', recurring: true, aiSuggested: null },
  { id: 't2', type: 'expense', categoryId: 'c6', category: 'Food', amount: 45.5, description: 'Campus Cafe lunch', date: '2026-09-22', recurring: false, aiSuggested: 'Food' },
  { id: 't3', type: 'expense', categoryId: 'c7', category: 'Transport', amount: 12, description: 'Bus pass top-up', date: '2026-09-21', recurring: false, aiSuggested: 'Transport' },
  { id: 't4', type: 'expense', categoryId: 'c10', category: 'Subscriptions', amount: 9.99, description: 'Spotify Student', date: '2026-09-20', recurring: true, aiSuggested: 'Subscriptions' },
  { id: 't5', type: 'expense', categoryId: 'c9', category: 'Academics', amount: 65, description: 'Textbook – Data Structures', date: '2026-09-18', recurring: false, aiSuggested: 'Academics' },
  { id: 't6', type: 'income', categoryId: 'c2', category: 'Part-time Job', amount: 120, description: 'Cafe weekend shifts', date: '2026-09-15', recurring: false, aiSuggested: null },
  { id: 't7', type: 'expense', categoryId: 'c11', category: 'Entertainment', amount: 28, description: 'Movie with friends', date: '2026-09-14', recurring: false, aiSuggested: 'Entertainment' },
  { id: 't8', type: 'expense', categoryId: 'c8', category: 'Hostel/Rent', amount: 350, description: 'September hostel fee', date: '2026-09-05', recurring: true, aiSuggested: 'Hostel/Rent' },
  { id: 't9', type: 'expense', categoryId: 'c6', category: 'Food', amount: 32, description: 'Food delivery – late night', date: '2026-09-12', recurring: false, aiSuggested: 'Food' },
  { id: 't10', type: 'expense', categoryId: 'c7', category: 'Transport', amount: 8.5, description: 'Uber to library', date: '2026-09-10', recurring: false, aiSuggested: 'Transport' },
  { id: 't11', type: 'income', categoryId: 'c4', category: 'Gift', amount: 50, description: 'Birthday gift from uncle', date: '2026-09-08', recurring: false, aiSuggested: null },
  { id: 't12', type: 'expense', categoryId: 'c12', category: 'Miscellaneous', amount: 15, description: 'Laundry tokens', date: '2026-09-07', recurring: false, aiSuggested: 'Miscellaneous' },
];

export const initialBudgets = [
  { id: 'b1', categoryId: 'c6', category: 'Food', limit: 150, month: '2026-09' },
  { id: 'b2', categoryId: 'c7', category: 'Transport', limit: 60, month: '2026-09' },
  { id: 'b3', categoryId: 'c11', category: 'Entertainment', limit: 50, month: '2026-09' },
  { id: 'b4', categoryId: 'c10', category: 'Subscriptions', limit: 30, month: '2026-09' },
  { id: 'b5', categoryId: 'c9', category: 'Academics', limit: 100, month: '2026-09' },
];
...
export const initialInsights = [
  {
    ...
    tip: 'Try a weekly food delivery cap of $25 — cooking 2 campus meals yourself could save ~$40 this month.',
...
export const initialTips = [
  ...
  { id: 'tip2', text: 'Spotify + other subscriptions total ~$10/mo. Check if any unused apps can be paused.', impact: 'medium', pinned: false, dismissed: false },
  { id: 'tip3', text: 'You’re $48 away from your $200 savings goal this month. Skip one outing to close the gap.', impact: 'high', pinned: false, dismissed: false },
...
export const announcements = [
  { id: 'a1', title: 'Welcome to Campus Coin!', body: 'Start by logging your first allowance and setting a Food budget.', active: true, createdAt: '2026-09-01' },
...
export const faqItems = [
  ...
  { q: 'Can I set budgets per category?', a: 'Yes. Set monthly limits (e.g. Food $150) and get in-app alerts when you near or exceed them.' },
...
export const aiCategoryHints = [
  ...
  { keywords: ['bus', 'uber', 'taxi', 'metro', 'transport', 'fuel', 'ride'], category: 'Transport' },
...
export const sixMonthTrend = [
  { month: 'Apr', income: 850, expense: 720 },
  { month: 'May', income: 900, expense: 780 },
  { month: 'Jun', income: 820, expense: 690 },
  { month: 'Jul', income: 950, expense: 810 },
  { month: 'Aug', income: 880, expense: 750 },
  { month: 'Sep', income: 970, expense: 565 },
];
